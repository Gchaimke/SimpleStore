<div class="card product-card mt-2">
    ...
    <div class="card-body">
        ...
        $product_id = $category->id.'_'.$product_num
        ?>
        <center>
            ...
            <div class="d-flex justify-content-center text-nowrap">
                ...
                <?= "<i class='fas fa-cart-plus product-to-cart' data-product_id='$product_id' data-product='$product->name' data-qty='$product->kind' data-price='$product->price'></i>" ?>
            </div>
        </center>
    </div>
</div>