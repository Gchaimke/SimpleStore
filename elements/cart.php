<div class="cart">
    ...
    <h6 class="card-title cart_header d-flex justify-content-center text-nowrap bg-info text-white p-2">
        <span class="me-2"><i class="fas fa-shopping-cart"></i> <span class="mobile-cart-total">0</span> ₪</span>
    </h6>
    <div class="cart-wraper text-center" style="display: none;">
        <ol class="cart_items text-start"></ol>
        <b style="font-size:1rem;"><?php lang($lng, "sum") ?>: <span class="cart-total">0</span> ₪</b>
        <div class="mx-2">
