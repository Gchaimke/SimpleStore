<div class="cart">
    ...
    <center>
        <h6 class="card-title cart_header d-flex justify-content-center text-nowrap bg-info text-white py-1">
            <span class="me-2"><?php lang($lng,"cart") ?></span>
    ...
    <center>
        <b class="cart-total-wraper" style="font-size:1rem;"><?php lang($lng,"sum") ?>: <span class="cart-total">0</span> ₪</b>
        <div>
            ...
            <a class="btn btn-outline-success text-info my-2 cart-send-email" aria-hidden="true"><i class="far fa-paper-plane"></i> <?php lang($lng,"send") ?></a>
        </div>
